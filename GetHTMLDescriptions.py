...
def getHTMLDescriptions():
    ...
    directories = filter(os.path.isdir, os.listdir('C:\Users\hkang\SCISS\Uniview Theater 2.0\Custom Modules'))
    ...
    for item in directories:
        ...
        for files in subdir:
            ...
            if files=="description.html":
                modulesWithDescriptions.append((os.path.join(subDirPath[56:],"description.html")))
